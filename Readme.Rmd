...
## __(B) Das OpenStreetMap Projekt__

### __(B1) Openstreetmap Projekt allgemein__

<<<<<<< HEAD
### B1 __Openstreetmap__ [Github](slides/OpenStreetMap.md)
=======
...
### __(B2) das Arbeiten mit XML-Dateien__

<<<<<<< HEAD
### __(B2) `osmdata` Paket__ ([Github](slides/osmdata.md))
=======
- Beispiel [*main OSM API*](slides/osm_mainapi.Rmd)
- Beispiel Overpass API 
>>>>>>> 7c70862562048dd83d35abf8915c3b64447f18d2
...
### __(B3) Interaktive Karten mit Javascript Bibliotheken__ ([Github](slides/using_javascript.md) | [pdf](slides/using_javascript.pdf)
| [rcode](rcode/using_javascript.R))
Beispiel - [Campingplätze](http://rpubs.com/Japhilko82/Campsites)

## Räumliche Analysen/Statistik

### __(B4) Das R-Paket `spdep` - Nachbarschaft und Distanz__ ([Browser](slides/spdep.md) | [pdf](slides/spdep.pdf) |
...
### __(B5) Simple Features__ ([Github](slides/simple_features.md) | [pdf](slides/simple_features.pdf)
