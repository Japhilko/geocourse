...
- Was ist das Ziel dieses Kurses und welche Datenquellen werden wir verwenden ([Github](`r paste0(coursepath,"slides/A1_Intro.md")`) | [pdf](`r paste0(coursepath,"slides/A1_Intro.pdf")`) 
