...
Zur georgraphischen Visualisierung sind neben Karten auch inhaltliche Daten notwendig ().
...
Viele Daten werden im Shapefile Format von ESRI angeboten. Das Format sowie Möglichkeiten die Daten zu importieren werden hier vorgestellt ([Github](`r paste0(coursepath,"slides/Shapefiles.md")`)).
