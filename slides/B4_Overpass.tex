...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tab_landcover <-}\StringTok{ }\KeywordTok{table}\NormalTok{(PLZ_SG}\OperatorTok{$}\NormalTok{land_cover.value)}
\NormalTok{df_landcover <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(tab_landcover)}
\KeywordTok{colnames}\NormalTok{(df_landcover)[}\DecValTok{1}\NormalTok{] <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Type_landcover"}\NormalTok{)}
\KeywordTok{kable}\NormalTok{(df_landcover)}
\end{Highlighting}
\end{Shaded}
