...
\title{B5 Das \texttt{osmdata} Paket}
...
\includegraphics{B5_osmdata_files/figure-beamer/unnamed-chunk-16-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat <-}\StringTok{ }\NormalTok{sf}\OperatorTok{::}\KeywordTok{st_read}\NormalTok{ (}\StringTok{'../data/Ladenburg_amenity.osm'}\NormalTok{, }
...
\includegraphics{B5_osmdata_files/figure-beamer/unnamed-chunk-24-1.pdf}
...
\begin{frame}[fragile]{Das Ergebnis graphisch darstellen}
\protect\hypertarget{das-ergebnis-graphisch-darstellen}{}
...
\begin{frame}[fragile]{Die Graphik erzeugen}
\protect\hypertarget{die-graphik-erzeugen}{}
