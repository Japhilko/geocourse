...
![](figure/logo_inspire.PNG)

### Targets:

- Make spatial information more accessible and interoperable
...
- Lade die Zensus Gemeinde Ergebniss [**hier**](https://www.zensus2011.de/SharedDocs/Aktuelles/Ergebnisse/DemografischeGrunddaten.html) herunter
...
- Gib die Gemeinde an, in der der Anteil der unter 1-jährigen am höchsten ist. 
...
### [Data for the American Community Survey:](http://www.census.gov/acs/www/)


![](figure/american_comsurvey.png)



## [The Humanitarian Data Exchange](https://data.hdx.rwlabs.org/dataset/rowca-ebola-cases)
