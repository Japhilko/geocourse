...
\KeywordTok{qtm}\NormalTok{(bb_poly)}
\end{Highlighting}
\end{Shaded}

\end{frame}

\begin{frame}[fragile]{Einrichtungen (amenity) in Amsterdam}
...
\includegraphics{osmdata_files/figure-beamer/unnamed-chunk-12-1.pdf}
