...
\begin{frame}[fragile]{A4A Übung: Visualisierung von Eurostat Daten}
...
\begin{block}{Zweiter Teil}

\begin{itemize}
\tightlist
\item
  Such Daten, in denen der Ländername enthalten ist und versuche diesen
  Datensatz mit \texttt{tmap} zu visualisieren.
\end{itemize}
