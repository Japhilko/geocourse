...
- Downlaod von OSM-Daten mit dem Paket `osmdata`, das auf der [**Overpass API**](https://wiki.openstreetmap.org/wiki/Overpass_API) beruht. 
...
![https://overpass-turbo.eu/](figure/Overpass_turbo_query_wizard_result_DE.png)
