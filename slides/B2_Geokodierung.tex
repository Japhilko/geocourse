...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{POI1 <-}\StringTok{ }\KeywordTok{geocode_OSM}\NormalTok{(}\StringTok{"B2, 1 Mannheim"}\NormalTok{)}
\NormalTok{POI2 <-}\StringTok{ }\KeywordTok{geocode_OSM}\NormalTok{(}\StringTok{"Hbf Mannheim"}\NormalTok{)}
\NormalTok{POI3 <-}\StringTok{ }\KeywordTok{geocode_OSM}\NormalTok{(}\StringTok{"Mannheim, Friedrichsplatz"}\NormalTok{)}
\NormalTok{ListPOI <-}\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{rbind}\NormalTok{(POI1}\OperatorTok{$}\NormalTok{coords,POI2}\OperatorTok{$}\NormalTok{coords,POI3}\OperatorTok{$}\NormalTok{coords))}
\NormalTok{ListPOI}
\end{Highlighting}
\end{Shaded}
...
\protect\hypertarget{wikipediaeintrage-in-der-nahe}{}
